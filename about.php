...
<div class="page">
    <div class="container">
        ...
        <div data-aos="zoom-in-left" data-aos-offset="200" class="about-container">
            ...
            <div class="about-text">
                <p>
                    ...
                    am passionate about software development and technology
                    in general.
                </p>
            </div>
        </div>
        <div data-aos="zoom-in-right" data-aos-offset="200" class="about-container">
            <div class="about-text">
                <h1>Education</h1>
                <p>
        ...
        <div class="about-container">
            ...
            <div data-aos="zoom-in-left" data-aos-offset="200" class="about-text">
                <h1>Skills</h1>
                <ul >
                    ...
                    <li>Web development: HTML, CSS, JavaScript, React, PHP, XAMPP</li>
                    <li>Database management: SQL, MySql</li>
                    <li>Data analysis: Python libraries (NumPy, Pandas, Matplotlib)</li>
                </ul>
            </div>
