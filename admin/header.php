...
<head>
    ...
    <title>Hoho-san Web Admin</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index.php" class="logo">
            <span class="logo-lg">Hoho-san Web Admin</span>
        </a>
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview <?php if (($cur_page == 'certificate.php')) {
                                        echo 'active';
                                    } ?>">
                    <a href="certificate.php">
                        <i class="fa fa-list-ol"></i> <span>Certificates</span>
                    </a>
                </li>
